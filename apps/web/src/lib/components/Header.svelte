...
<!--
  ...
  <div class="navbar-center justify-center navbar_logo_div">
    ...
    <a href="/" class="text-xl">
      <img id="navbar-bushbash" src="https://u.cubeupload.com/oreophone/logosignless.png" alt="BushBashCTF" class="navbar_logo">
      </a>
    {:else}
    <a href="https://cssa.club" class="navbar_cssa"> <!-- the cssa svg lol ik this is kinda stupid -->
      <img id="navbar-cssasign" src="https://u.cubeupload.com/oreophone/cssasign.png" alt="CSSA Presents..." class="navbar_logo">
    </a>
    {/if}
  </div>
